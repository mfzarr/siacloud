...
@section('content')
                    ...
                    <form id="jabatanForm" action="{{ route('jabatan.store') }}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="asuransi" id="asuransi"
                                class="form-control @error('asuransi') is-invalid @enderror" required
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="tarif" id="tarif"
                                class="form-control @error('tarif') is-invalid @enderror" required placeholder="10.000.000">
                            @error('tarif')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
    ...
    <script>
        ...
        document.getElementById("saveButton").addEventListener("click", function() {
            ...
            if (!isValid) {
                return; // Stop execution if validation fails without showing SweetAlert
            }

            // If client-side validation passes, show SweetAlert for confirmation
            Swal.fire({
