            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form id="kategoriForm"  action="{{ route('kategori-produk.update', $kategori_barang->id_kategori_barang) }}" method="POST">
                                @csrf
                                @method('PUT')
    ...
    <script>
        document.getElementById("saveButton").addEventListener("click", function() {
            ...
            Swal.fire({
                ...
                text: "Are you sure you want to edit this Kategori Produk?",
                icon: "question",
